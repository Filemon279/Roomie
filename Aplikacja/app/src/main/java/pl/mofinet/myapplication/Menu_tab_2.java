...
public class Menu_tab_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
     ...
     //   Hotel_map.mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(ostrow_point, 16.0f));
        ...
        Hotel_map.mMap.addMarker(new MarkerOptions().position(ostrow_point).title("Marker in Sydney"));
        Hotel_map.mMap.addMarker(new MarkerOptions().position(uwr_point).title("Marker in Sydney"));
        Hotel_map.mMap.addMarker(new MarkerOptions().position(rynek_point).title("Marker in Sydney"));
